(function () {
    ...
    function updateImages(theme) {
        ...
        homeImg.src = `screenshots/${mode}/main.png`;
        savedImg.src = `screenshots/${mode}/templates.png`;
        settingsImg.src = `screenshots/${mode}/settings.png`;
    }
    ...
    apkDownloadBtn.addEventListener('click', (e) => {
        ...
        setTimeout(() => {
            ...
            link.href = 'apk/PlanGPT.apk';
            link.download = 'PlanGPT.apk';
